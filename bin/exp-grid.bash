...
# Parallel execution of bin/exp-grid.bash
#
# This script executes the bin/exp-grid.py script in parallel
...
# Usage:
# To run exp-grid.py for all datasets & 5 iterations, run the
# following command:
#
#    ./bin/exp-grid.bash 5
#
...
echo "${DATASETS[@]}" |
    xargs -n 2 -P 0 python3 bin/exp-grid.py
