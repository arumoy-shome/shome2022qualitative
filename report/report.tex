...
%% We recommend that practitioners still take the necessary actions to
%% mitigate bias in the model using the appropriate techniques.

%% TODO luis: can you provide some citations here to back the claim
%% that reducing training sample slightly does not harm the
%% performance but does help with efficiency & sustainability?
